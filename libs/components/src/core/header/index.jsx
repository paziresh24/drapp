...
import { ChevronIcon, ConsultIcon, ExitIcon, HelpIcon, HouseIcon, UserIcon } from '../../icons';
                                        ...
                                        <div className={styles.row}>
                                            ...
                                            >
                                                <path
                                                    fillRule="evenodd"
                                                    clipRule="evenodd"
                                                    d="M2.23242 11.0467C4.65561 8.40469 8.13397 6.75 11.9999 6.75C15.8658 6.75 19.3442 8.40469 21.7674 11.0467C22.0474 11.352 22.5218 11.3725 22.8271 11.0925C23.1323 10.8126 23.1528 10.3381 22.8729 10.0329C20.1775 7.09407 16.3035 5.25 11.9999 5.25C7.6963 5.25 3.8223 7.09407 1.12696 10.0329C0.846986 10.3381 0.867486 10.8126 1.17275 11.0925C1.47801 11.3725 1.95245 11.352 2.23242 11.0467ZM5.66059 13.2638C7.31691 11.7044 9.54612 10.75 11.9999 10.75C14.4536 10.75 16.6829 11.7044 18.3392 13.2638C18.6408 13.5477 19.1154 13.5334 19.3993 13.2318C19.6833 12.9302 19.669 12.4556 19.3674 12.1716C17.4439 10.3608 14.8508 9.25 11.9999 9.25C9.14898 9.25 6.55587 10.3608 4.63238 12.1716C4.3308 12.4556 4.31648 12.9302 4.60042 13.2318C4.88435 13.5334 5.35901 13.5477 5.66059 13.2638ZM11.9998 14.75C10.7 14.75 9.51213 15.2214 8.59509 16.0035C8.27993 16.2723 7.80655 16.2347 7.53776 15.9196C7.26897 15.6044 7.30656 15.131 7.62172 14.8622C8.79999 13.8573 10.3299 13.25 11.9998 13.25C13.6697 13.25 15.1996 13.8573 16.3779 14.8622C16.693 15.131 16.7306 15.6044 16.4618 15.9196C16.193 16.2347 15.7197 16.2723 15.4045 16.0035C14.4875 15.2214 13.2996 14.75 11.9998 14.75ZM12 19C12.5523 19 13 18.5523 13 18C13 17.4477 12.5523 17 12 17C11.4477 17 11 17.4477 11 18C11 18.5523 11.4477 19 12 19Z"
                                                    fill="#3F3F79"
                                                />
                                            </svg>
