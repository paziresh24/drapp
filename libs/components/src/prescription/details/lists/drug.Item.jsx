...
const DrugItem = ({ service }) => {
    ...
    useEffect(() => {
        if (!service.active_from && prescriptionInfo.insuranceType === 'salamat') {
    ...
    const editDate = date => {
        if (date) {
            const dateFormat = date
                ...
                : null;
            setDate(dateFormat);
            services[services.findIndex(item => item.id === service.id)].active_from = dateFormat;
            setServices(services);
        }
    };
                    ...
                    {prescriptionInfo.insuranceType === 'salamat' && (
                        <td data-label="تاریخ موثر">
                            <SelectDate
                                ...
                                // today
                                default-value={service.active_from}
                            />
                        </td>
                    )}
                    <td>
            ...
            <Mobile>
                ...
                >
                    ...
                    <div className={styles.amounts}>
                        ...
                        <SelectBox value={service.use_time} editable={false} type="Consumption" />
                        <SelectBox
                            value={service.how_to_use}
                            editable={false}
                            type="Instructions"
