...
import { MinusLineIcon, PlusLineIcon } from '@paziresh24/shared/icon';
...
const EquipmentDetails = ({ services, setServices, insuranceType, noDate = false }) => {
