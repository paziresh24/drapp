...
// List of paths that should be excluded from service worker handling
// These paths will bypass the service worker and go directly to the server
...
registerRoute(
    ...
    ({ request, url }) => {
        ...
        // Check if this path is in the excluded list
