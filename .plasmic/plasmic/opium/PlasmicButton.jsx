...
import sty from "./PlasmicButton.module.css"; // plasmic-import: SlwriOmgnMc5/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: RXQqhirPqnrh/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: paTAb-KTBp4m/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__kgJfL)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg___5ZKYf)}
                role={"img"}
              />
            ),
