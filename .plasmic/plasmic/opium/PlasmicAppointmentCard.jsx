...
import PatientPrivateData from "../../PatientPrivateData"; // plasmic-import: NQ_NX6MhhQIl/component
import Button from "../../Button"; // plasmic-import: oVzoHzMf1TLl/component
import TextInput from "../../TextInput"; // plasmic-import: 9dVD7GIhbUbw/component
import SafeCall from "../../SafeCall"; // plasmic-import: -iBTMaXovDap/component
import BookStatusButton from "../../BookStatusButton"; // plasmic-import: KtECYHTeUhsP/component
...
export const PlasmicAppointmentCard__VariantProps = new Array("onlineBorder");

export const PlasmicAppointmentCard__ArgProps = new Array(
  "cell",
  "name",
  "time",
  "date",
          ...
          >
            ...
            <div className={classNames(projectcss.all, sty.freeBox__eHDpq)}>
              ...
              <PatientPrivateData
                className={classNames(
                  "__wab_instance",
                  sty.patientPrivateData___96092
                )}
                label={"\u0645\u0648\u0628\u0627\u06cc\u0644"}
                transparent={true}
                value={(() => {
              ...
              {(() => {
                ...
                <PatientPrivateData
                  className={classNames(
                    "__wab_instance",
                    sty.patientPrivateData___6Z2Lw
                  )}
                  label={"\u0646\u0627\u0645 \u0645\u0631\u06a9\u0632"}
                  value={(() => {
                    try {
