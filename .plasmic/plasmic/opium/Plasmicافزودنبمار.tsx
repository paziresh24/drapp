...
export type Plasmicافزودنبمار__VariantMembers = {};
export type Plasmicافزودنبمار__VariantsArgs = {};
type VariantPropType = keyof Plasmicافزودنبمار__VariantsArgs;
export const Plasmicافزودنبمار__VariantProps = new Array<VariantPropType>();

export type Plasmicافزودنبمار__ArgsType = {
  centerId?: string;
  serviceId?: string;
  userCenterId?: string;
  type?: string;
...
type ArgPropType = keyof Plasmicافزودنبمار__ArgsType;
export const Plasmicافزودنبمار__ArgProps = new Array<ArgPropType>(
  "centerId",
  "serviceId",
  "userCenterId",
  "type",
...
export type Plasmicافزودنبمار__OverridesType = {
  root?: Flex__<"div">;
...
function Plasmicافزودنبمار__RenderFunc(props: {
  variants: Plasmicافزودنبمار__VariantsArgs;
  args: Plasmicافزودنبمار__ArgsType;
  overrides: Plasmicافزودنبمار__OverridesType;
  forNode?: string;
}) {
    ...
    >
      ...
      {(() => {
        ...
        <Dialog
                                ...
                                const actionArgs = {
                                  customFunction: async () => {
                                    return (() => {
                                      ...
                                      const url = `https://apigw.paziresh24.com/v2/book?center_id=${
                                        $props.centerId
                                      }&user_center_id=${
                                        $props.userCenterId
                                      }&service_id=${
                                        ...
                                        $state.freeTurnData.request_code
                                      }&fullname=${encodeURI(
                                        $state.fullname
                                      )}&cell=${$state.cell}&national_code=${
          ...
          onOpenChange={generateStateOnChangeProp($state, ["booktime", "open"])}
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  Plasmicافزودنبمار__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<Plasmicافزودنبمار__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      Plasmicافزودنبمار__ArgsType,
      ReservedPropsType
    > &
