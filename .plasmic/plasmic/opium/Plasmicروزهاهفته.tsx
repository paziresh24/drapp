...
import sty from "./Plasmicروزهاهفته.module.css"; // plasmic-import: oTc6QTbblo0F/css
...
export type Plasmicروزهاهفته__VariantMembers = {};
export type Plasmicروزهاهفته__VariantsArgs = {};
type VariantPropType = keyof Plasmicروزهاهفته__VariantsArgs;
export const Plasmicروزهاهفته__VariantProps = new Array<VariantPropType>();

export type Plasmicروزهاهفته__ArgsType = {
  selectedDay?: number;
  selectTrigger?: (days: any) => void;
};
type ArgPropType = keyof Plasmicروزهاهفته__ArgsType;
export const Plasmicروزهاهفته__ArgProps = new Array<ArgPropType>(
  "selectedDay",
  "selectTrigger"
);

export type Plasmicروزهاهفته__OverridesType = {
  root?: Flex__<"div">;
  text?: Flex__<"div">;
...
export interface DefaultروزهاهفتهProps {
  selectedDay?: number;
  selectTrigger?: (days: any) => void;
  className?: string;
}
...
function Plasmicروزهاهفته__RenderFunc(props: {
  variants: Plasmicروزهاهفته__VariantsArgs;
  args: Plasmicروزهاهفته__ArgsType;
  overrides: Plasmicروزهاهفته__OverridesType;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  Plasmicروزهاهفته__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<Plasmicروزهاهفته__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    /* Specify args directly as props*/ Omit<
      Plasmicروزهاهفته__ArgsType,
      ReservedPropsType
    > &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: Plasmicروزهاهفته__ArgProps,
          internalVariantPropNames: Plasmicروزهاهفته__VariantProps
        }),
      [props, nodeName]
    );
    return Plasmicروزهاهفته__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    ...
    func.displayName = `Plasmicروزهاهفته.${nodeName}`;
  }
  return func;
}

export const Plasmicروزهاهفته = Object.assign(
  // Top-level Plasmicروزهاهفته renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for Plasmicروزهاهفته
    internalVariantProps: Plasmicروزهاهفته__VariantProps,
    internalArgProps: Plasmicروزهاهفته__ArgProps
  }
);

export default Plasmicروزهاهفته;
/* prettier-ignore-end */
