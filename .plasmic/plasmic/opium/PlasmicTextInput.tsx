...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 9dVD7GIhbUbw/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__nlGPy)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__mtLvi)}
              role={"img"}
            />
          ),
